...
<body>
	...
	<div id="div">
		...
		<span class="div-f" id="div-r"><div style="font-size:24px;line-height: 30px;"><?php if(isset($message)) { echo($message); }else{ echo($error); }?></div><div>页面自动 <a id="href" href="<?php echo($jumpUrl); ?>">跳转</a> 等待时间：<span id="wait"><?php echo($waitSecond); ?></span></div></span>
	</div>
