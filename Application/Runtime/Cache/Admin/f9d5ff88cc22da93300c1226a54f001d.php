...
<html>
	...
	<body>
		<form action="" method="post" enctype="multipart/form-data">
			...
			<input id="exampleInputEmail1" class="form-control" type="text" placeholder="请输入文章标题" required="" name="his_title">
		</div>
			<div class="form-group">
				<label for="exampleInputEmail1">作者</label>
				<input id="" class="form-control" type="text" placeholder="请输入作者" required="" name="his_author">
			</div>
			<div>
			...
			<div class="form-group">
				...
				<script id="editor" type="text/plain" style="width:100%;height:200px;" name="his_content"></script>
				<script>
