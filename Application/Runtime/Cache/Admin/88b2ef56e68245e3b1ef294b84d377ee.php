...
<html>
	...
	<body>
		<form action="" method="post" enctype="multipart/form-data">
			...
			<input id="exampleInputEmail1" class="form-control" type="text" placeholder="请输入文章标题" required="" name="his_title" value="<?php echo ($oldData["his_title"]); ?>">
		</div>
			<div>
			<div class="form-group">
				<label for="exampleInputEmail1">编辑作者</label>
				<input id="" class="form-control" type="text" placeholder="请输入作者" required="" name="his_author" value="<?php echo ($oldData["his_author"]); ?>">
			</div>
					<div>编辑标题分类</div>
				<div>
			...
			<div class="form-group">
				...
				<script id="editor" type="text/plain" style="width:100%;height:200px;" name="his_content"><?php echo ($oldData["his_content"]); ?></script>
				<script>
