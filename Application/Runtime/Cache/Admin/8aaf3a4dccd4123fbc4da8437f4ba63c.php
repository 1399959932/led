...
<html>
	...
	<body>
		<form action="" method="post" enctype="multipart/form-data">
			...
			<input id="exampleInputEmail1" class="form-control" type="text" placeholder="请输入文章标题" required="" name="medart_title">
		</div>
			...
			<div>
				...
				<div>
					<select name="medart_expert_id"  >
						...
						<?php if(is_array($expData)): foreach($expData as $key=>$vo): ?><option value="<?php echo ($vo["expert_id"]); ?>"><?php echo ($vo["expert_username"]); ?></option><?php endforeach; endif; ?>
			...
			<div class="form-group">
				...
				<script id="editor" type="text/plain" style="width:100%;height:200px;" name="medart_content"></script>
				<script>
