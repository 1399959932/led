			...
			<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					<a href="javascript:;">
						...
						<span class="title">医学文章管理</span>
						<span class="arrow "></span>
					</a>
					<ul class="sub-menu">
						<li>
							<a href="<?php echo U('Medart/add');?>">
							添加新闻</a>
						</li>
						<li>
							<a href="<?php echo U('Medart/index');?>">
							案例列表</a>
						</li>
				...
				<li>
					<a href="javascript:;">
						<i class="icon-briefcase"></i>
						<span class="title">历史文章管理</span>
						<span class="arrow "></span>
					</a>
					<ul class="sub-menu">
						<li>
							<a href="<?php echo U('History/add');?>">
							添加</a>
						</li>
						<li>
							<a href="<?php echo U('History/index');?>">
							历史文章列表</a>
						</li>
				...
				<li>
					<a href="javascript:;">
						<i class="icon-briefcase"></i>
						<span class="title">需救助人员</span>
						<span class="arrow "></span>
					</a>
					<ul class="sub-menu">
						<li>
							<a href="<?php echo U('Rescue/add');?>">
							添加需救助人员</a>
						</li>
						<li>
							<a href="<?php echo U('Rescue/index');?>">
							需救助人员列表</a>
						</li>
					</ul>
				</li>
