...
<html>
	...
	<body>
		<form action="" method="post" enctype="multipart/form-data">
			...
			<input id="exampleInputEmail1" class="form-control" type="text" placeholder="请输入文章标题" required="" name="newsart_title" value="<?php echo ($oldData["newsart_title"]); ?>">
		</div>
			<div class="form-group">
				<label for="exampleInputEmail1">编辑作者</label>
				<input id="" class="form-control" type="text" placeholder="请输入作者" required="" name="newsart_author" value="<?php echo ($oldData["newsart_author"]); ?>">
			</div>
			<div>
			...
			<table class='table table-bordered'>
				<tr class="info" id="uploadList">
					<td>
						 <img src="{newsart_pic}" alt="" width="600" height="600">
					</td>
					<td>修改图片</td>
			...
			<div class="form-group">
				...
				<script id="editor" type="text/plain" style="width:100%;height:200px;" name="newsart_content"><?php echo ($oldData["newsart_content"]); ?></script>
				<script>
