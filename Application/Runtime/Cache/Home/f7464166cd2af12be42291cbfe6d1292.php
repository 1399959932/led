...
<link rel="stylesheet" href="Public/Home/js/vendor/magnific/magnific-popup.min.css" type="text/css" media="all" />
	...
	<body class="logon page index body_style_wide body_filled article_style_stretch scheme_original top_panel_show top_panel_above sidebar_hide">
...
<div class="header_mobile">
    ...
    <div class="mask"></div>
                        ...
                        <div class="panel_top">
                            <nav class="menu_main_nav_area">
                                <ul id="menu_main_mobile" class="menu_main_nav">
                                    ...
                                    <li><a href="opy.html">眼科医学</a></li>
									<li><a href="news.html">新闻中心</a></li>
									<li><a href="expert.html">眼科专家</a></li>
									<li><a href="history.html">眼科历史</a></li>
									<li><a href="company.html">医疗企业</a></li>
					...
					<div class="top_panel_title_inner top_panel_inner_style_3 breadcrumbs_block_bg3">
						<div class="content_wrap">
							...
							<div class="breadcrumbs">
								...
								<span class="breadcrumbs_item current">企业注册</span>
				...
				<!-- /Breadcrumbs -->
				 <div class="content_wrap">
					<div id="popup_login" class="popup_wrap popup_logon bg_tint_light animated fast">
					<div class="form_wrap">
						<div class="form_left">
							<form action="" name="login_form" class="popup_form registration_form" id="form" method="post">
								<div class="popup_form_field iconed_field registration_username icon-user">
									<input type="text" id="registration_username" name="company_name" value="" placeholder="请输入公司名称">
								</div>
								<div class="popup_form_field password_field iconed_field icon-lock">
									<input type="password" id="registration_pwd" name="company_password" value="" placeholder="请输入密码">
								</div>
								<div class="popup_form_field password2_field iconed_field icon-lock">
									<input type="password" id="registration_pwd2" name="company_password2" value="" placeholder="请再次输入密码">
								</div>
								<div class="popup_form_field phone_field iconed_field icon-phone">
									<input type="text" id="phone" name="company_phone" value="" placeholder="手机号">
								</div>
								<div class="popup_form_field e-mail_field iconed_field icon-mail">
									<input type="text" id="registration_email" name="company_email" value="" placeholder="邮箱">
								</div>		
								<div class="popup_form_field yanz_field iconed_field">
                                    <input type="text" class="column-1_2inp" name="authcode" id="registration_yanz" value="" placeholder="请输入验证码"/>

                                    <cite >
                                        <img src="<?php echo U('Userreg/selfverify');?>" onclick="this.src=this.src"/>
                                    </cite>
								</div>
								<div class="popup_form_field submit_field">
                                    <input type="hidden" name="company_time">
									<input type="submit" id="my_button" class="submit_button" value="注册">
								</div>
							</form>
						</div>
						<div class="form_right">
							<div class="login_socials_title">您可以使用您的社交资料登录</div>
		                                        <div class="sc_socials sc_socials_type_icons sc_socials_size_tiny">
		                                            <div class="sc_socials_item">
		                                                <a href="javascript:;" target="_blank" class="social_icons social-qq">
		                                                   <span class="icon-qq"></span>
		                                                </a>
		                                            </div>
		                                            <div class="sc_socials_item">
		                                                <a href="javascript:;" target="_blank" class="social_icons social-weibo">
		                                                   <span class="icon-weibo"></span>
		                                                </a>
		                                            </div>
		                                        </div>
							<div>如果您已经拥有账号请您直接</div>
							<a href="login_company.html" class="logon_btn">登陆账号</a>
